...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Project Flow" },
      { property: "og:description", content: "Visão geral das suas tasks, entregas e produtividade." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Project Flow" },
      { name: "twitter:description", content: "Visão geral das suas tasks, entregas e produtividade." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/64a0b136-7742-4fa9-b2d5-2ff389b2c070/id-preview-3f6362df--122de352-3847-4b50-9352-d9784f237a00.lovable.app-1783607573948.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/64a0b136-7742-4fa9-b2d5-2ff389b2c070/id-preview-3f6362df--122de352-3847-4b50-9352-d9784f237a00.lovable.app-1783607573948.png" },
    ],
