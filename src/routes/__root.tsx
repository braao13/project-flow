...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Projetin — Timeline-driven project management" },
      { name: "description", content: "Gerencie projetos e tasks através de uma timeline de atualizações." },
      { name: "theme-color", content: "#0b0a14" },
      { property: "og:title", content: "Projetin — Timeline-driven project management" },
      { property: "og:description", content: "Gerencie projetos e tasks através de uma timeline de atualizações." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Projetin — Timeline-driven project management" },
      { name: "twitter:description", content: "Gerencie projetos e tasks através de uma timeline de atualizações." },
